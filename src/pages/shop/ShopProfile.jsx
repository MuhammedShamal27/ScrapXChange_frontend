          ...
          <div className="flex flex-1 justify-center bg-bgColor rounded-lg">
            <div className="bg-white rounded-2xl m-10">
              <div className="flex flex-col ">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-y-10 gap-7 m-5 text-xs">
                  ...
                  <div className="rounded-xl p-3 shadow">
                    ...
                    <p className="text-black">
                      {shopProfile.shop_license_number}
                    </p>
                  </div>
                  <div className="rounded-xl p-3 shadow">
                  ...
                  <div className="rounded-xl p-3 shadow">
                    ...
                    <p className="text-black">{shopProfile.pincode}</p>
                  </div>
                  <div className="rounded-xl p-3 shadow">
                ...
                {!isUploadAllowed && (
                  <p className="text-xs font-bold ml-7 text-red-500">
                    NOTE : Once uploaded,you can only update your location and
                    image after 30 days.
                  </p>
                )}
              </div>
