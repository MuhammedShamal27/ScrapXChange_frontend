...
import { fetchUserList, blockedUserList, unblockedUserList } from '../../services/api/admin/adminApi';
    ...
    <>
      <div className='adminFont flex bg-bgColor '>
        ...
        <div className='w-8/12'>
          <HeadingAndProfile />
          <div>
            <UserAndAdminList list={users} type="users" setFilter={setFilter} setSearchQuery={setSearchQuery} />
          </div>
        </div>
      </div>
