...
import { fetchShopList, fetchBlockedShopList, fetchUnblockedShopList } from '../../services/api/admin/adminApi';
    ...
    <>
      <div className='adminFont flex bg-bgColor '>
        ...
        <div className='w-8/12'>
          <HeadingAndProfile />
          <div>
            <UserAndAdminList list={shops} type="shops" setFilter={setFilter} setSearchQuery={setSearchQuery} />
          </div>
        </div>
      </div>
