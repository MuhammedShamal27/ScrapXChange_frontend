...
const ShopRequestList = () => {
  ...
  return (
    <>
      <div className="adminFont flex lg:flex-row bg-bgColor min-h-screen">
        <AdminNavBar />
          ...
          <div className="bg-white lg:ml-11 rounded-2xl p-6">
            ...
            <div className="flex flex-col mt-5 space-y-3">
              {shopRequests.length === 0 ? (
                <p className="text-center font-bold text-xl m-10">
                  ...
                  >
                    <div className="lg:w-1/4 flex items-center space-x-3">
                      <img
                        src={
                          request.profile_picture
                            ? `${baseURL}${request.profile_picture}`
                            : Shop_requests
                        }
                        alt="profile"
                      ...
                      <p className="text-gray-700 font-medium">
                        {request.shop.shop_name}
                      </p>
                    </div>
                    <p className="w-full lg:w-1/4 text-center text-gray-700">
                      {request.email}
                    </p>
                    <p className="w-full lg:w-1/4 text-center text-gray-700">
