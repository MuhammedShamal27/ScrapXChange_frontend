                ...
                <div className='flex flex-col mt-5 ml-5 justify-around'>
                    <div className='flex space-x-40  items-center '>
                        <div className='flex m-3 items-center space-x-3'>
                            <img src={USA_profile} alt="profile" />
                            <p>Shop Name</p>
                        </div>
                        <p>ansabph@gmail.com</p>
                        <p >9874563254</p>
                        <button className='bg-black text-white rounded-3xl text-xs w-20 font-light p-2'>Details</button>
                        <br/>
                    </div>
                    <div className='flex space-x-40  items-center '>
                        <div className='flex m-3 items-center space-x-3'>
